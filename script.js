...
heading.innerHTML = "HTML SUBMISSION FORM"
heading.style.textAlign = "center";

var form = document.createElement('form');
form.setAttribute('class', 'p-5')

var fname = createElements('First Name', 'text', 'fname');
var lname = createElements('Last Name ', 'text', 'lname');
var address = createElements('Address ', 'textarea', 'address');
var pincode = createElements('Pincode ', 'text', 'pin');
...
function createElements(lbltxt, typ, idname) {
    var d = document.createElement('div');
...
function createMultiSelect() {
    ...
    var option1 = new Option('Pizza', 'Pizza');

    var option2 = new Option('Idli', 'Idli');
    var option3 = new Option('Dosa', 'Dosa');
    var option4 = new Option('Maggi', 'Maggi');
    var option5 = new Option('Biryani', 'Biryani');
...
function createState() {
    ...
    select.id = 'state'
    select.setAttribute('class', 'form-control col-6')
    var option1 = new Option('Andhra Pradesh', 'Andhra Pradesh');
    option1.selected = true;
    var option2 = new Option('Karnataka', 'Karnataka');
    var option3 = new Option('Tamilnadu', 'Tamilnadu');
    var option4 = new Option('Kerala', 'Kerala');
    var option5 = new Option('Madhya Pradesh', 'Madhya Pradesh');
    var option6 = new Option('Haryana', 'Haryana');
    var option7 = new Option('Gujarat', 'Gujarath');
...
function createCountry() {
    ...
    select.setAttribute('class', 'form-control col-6')
    select.id = 'country'
    var option1 = new Option('India', 'India');
    option1.selected = true;
    var option2 = new Option('USA', 'USA');
    var option3 = new Option('Australia', 'Australia');
    var option4 = new Option('South Africa', 'South Africa');
    var option5 = new Option('New Zealand', 'New Zealand');
    var option6 = new Option('England', 'England');
    var option7 = new Option('West Indies', 'West Indies');
